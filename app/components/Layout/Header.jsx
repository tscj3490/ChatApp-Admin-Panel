                ...
                <nav role="navigation" className="navbar topnavbar">
                    ...
                    <div className="navbar-header">
                        <a href="#/" className="navbar-brand">
                            <div className="brand-logo p0">
                                <img src="img/logo.png" alt="App Logo" className="img-responsive" style={{height:55}}/>
                            </div>
                            <div className="brand-logo-collapsed">
                                <img src="img/logo.png" alt="App Logo" className="img-responsive" style={{height:40, objectFit:'auto'}}/>
                            </div>
                        </a>
                    </div>
                    { /* END navbar header */ }
