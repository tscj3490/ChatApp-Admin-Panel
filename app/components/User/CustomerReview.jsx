...
class CustomerReview extends React.Component {
    ...
    componentDidMount() {
        Api.getReviewByCustomer(this.state.id, (err, res) => {
            console.log(err,res)
            if (err == null) {
                this.setState({ reviews: res.items })
            }
        })
    }
    ...
    deleteItem(index) {
        swal({
            ...
            () => {
                DonationApi.deleteOrder(this.state.reviews[index].ID, (err, res) => {
                    if (err == null) {
    ...
    //                 <div className="h4 text-center">Review Information</div>
    //                 <Row className="pv-lg">
    //                     <Col lg={2}></Col>
    //                     <Col lg={8}>
    ...
    render() {
        return (
            <ContentWrapper>
                <h3>{this.state.customerName}'s Review
                </h3>
                <Row>
                    <Col lg={12}>
                        { /* START panel */}
